...
//		Compra nuevacompra = controlaCompra.findByPK(1);
//		Usuario pk4 = controlaUsur.findByPK(8);
////		nuevacompra.setUsuario(pk4);
////		controlaCompra.crearEntidad(nuevacompra);
//
//		Producto nuevoProducto = controlaPro.findByPK(6);
//
